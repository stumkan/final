...
def header_footer(canvas, doc):
    ...
    # Footer
    footer_text = "This is a confidential document created by 10db Studios. All rights reserved. Company established in 2024."
...
def generate_fault_report(file_path, fault_ref, fault_start, fault_end, fault_duration, events, conclusion):
    """
    Function to generate a fault report PDF with a consistent header, footer, and background color.
    """
    ...
    # Fault stats
    content.append(Paragraph("Fault Stats", heading3_style))
